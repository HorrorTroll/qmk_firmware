...
VALID_POINTING_DEVICE_DRIVER_TYPES := adns5050 adns9800 analog_joystick cirque_pinnacle_i2c cirque_pinnacle_spi paw3204 pmw3320 atg4090 pmw3325 pmw3360 pmw3389 pimoroni_trackball custom
ifeq ($(strip $(POINTING_DEVICE_ENABLE)), yes)
    ifeq ($(filter $(POINTING_DEVICE_DRIVER),$(VALID_POINTING_DEVICE_DRIVER_TYPES)),)
        ...
        ifeq ($(strip $(POINTING_DEVICE_DRIVER)), adns9800)
            ...
            QUANTUM_LIB_SRC += i2c_master.c
        else ifneq ($(filter $(strip $(POINTING_DEVICE_DRIVER)),pmw3325 pmw3360 pmw3389),)
            OPT_DEFS += -DSTM32_SPI -DHAL_USE_SPI=TRUE
