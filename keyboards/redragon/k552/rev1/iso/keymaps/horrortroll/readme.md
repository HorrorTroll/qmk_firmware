# ANSI layout with extra RGB matrix effect

This is ANSI layout with extra RGB matrix effect
...
How to compile: `qmk compile -kb redragon/k552/rev1/ansi -km horrortroll`