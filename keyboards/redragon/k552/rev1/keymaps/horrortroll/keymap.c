...
enum layer_keycodes {
  ...
  RGB_G                   //Change effect to glitter
...
*/
    ...
    [_FL]   = LAYOUT_ansi(
                ...
                _______, G1_HUD,  G1_HUI,  G1_SAD,  G1_SAI,  G1_VAD,  G1_VAI,  _______, _______, _______, _______, _______, _______, _______, RGB_K,   TG(_CSGO), RGB_G,
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    ...
    [_CSGO] = { Red,              ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  Red,     ______,  ______,  ______,  ______,   ______, \
                ...
                Orange,  ______,  ______,                             ______,                             ______,  ______,  ______,  ______,  ______,  ______,   ______ },

    [_FL]   = { White,            Green,   Green,   Green,   Green,   Green,   Green,   Green,   Green,   Green,   Green,   Green,   Green,   Orange,  Orange,   Orange, \
                ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  Orange,  Orange,  ______,  Sakura,  Sakura,   Sakura, \
                ...
                ______,  Sakura,  ______,                             ______,                             ______,  ______,  ______,  ______,  Orange,  Orange,   Orange },
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
	...
	case RGB_K:
      ...
      break;
	case RGB_G:
      rgb_matrix_mode_noeeprom(RGB_MATRIX_CUSTOM_GLITTER);
      return false;
      break;
  }
  return true;
