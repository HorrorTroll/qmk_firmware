...
enum layer_keycodes {
  ...
  RGB_G                   //Change effect to per-key LED for CSGO game
...
*/
    ...
    [_FL]   = LAYOUT_ansi(
                ...
                _______, G1_HUD,  G1_HUI,  G1_SAD,  G1_SAI,  G1_VAD,  G1_VAI,  _______, _______, _______, _______, _______, _______, _______, RGB_K,   CSGO,     _______,
